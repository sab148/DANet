...
class HourglassNet(nn.Module):
    ...
    def __init__(self, block, num_stacks=2, num_blocks=4, num_classes=16, threshold=0.6, args=None):
    ...
    def forward(self, x, label=None):
        ...
        for i in range(self.num_stacks):
            ...
            localization_map_normed = self.get_atten_map(score, label, True)
            self.attention = localization_map_normed
            score = self.erase_feature_maps(localization_map_normed, score, self.threshold)
    ...
    def get_cam_maps(self):
        map1 = self.normalize_atten_maps(self.maps[0])
        map_erase = self.normalize_atten_maps(self.maps[1])
